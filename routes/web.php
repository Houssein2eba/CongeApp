...
// Routes publiques (accueil, login, register)
Route::get('/',function(){
    return view('welcome');
})->name('welcome');
...
// Routes protégées admin (auth + gate)
...
// Routes protégées employé (auth + gate)
Route::middleware(['auth'])->prefix('employe')->name('employes.')->group(function () {
...
// Route de debug pour tester l'accès Gate
